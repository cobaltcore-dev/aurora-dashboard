...
describe("DeactivateImageModal", () => {
  ...
  it("should render the modal when isOpen is true", () => {
    ...
    expect(screen.getByText(/Deactivating this image will prevent/i)).toBeInTheDocument()
  })
  ...
  it("should show spinner and hide details when isLoading is true", () => {
    ...
    expect(screen.queryByText(/Deactivating this image will prevent/i)).not.toBeInTheDocument()
  })
