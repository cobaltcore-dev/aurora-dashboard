...
export const Route = createFileRoute("/_auth/projects/$projectId/services/pca/")({
  staticData: { section: "services", service: "pca", sectionCrumb: { label: "Services", to: "/projects/$projectId/services/overview" }, crumb: { label: "PCA (Clavis)" } } satisfies RouteInfo,
  head: () => ({ meta: [{ title: "PCA" }] }),
