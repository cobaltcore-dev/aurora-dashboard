...
fix(server): enable trustProxy for correct hostname detection behind reverse proxy

When running behind a reverse proxy (Ingress), Fastify now correctly reads the
