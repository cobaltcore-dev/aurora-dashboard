...
type CloudProfile = Awaited<ReturnType<TrpcClient["getCloudProfiles"]["query"]>>[number]
...
const CreateClusterDialogContent: React.FC<{
  ...
  const handleSubmit = async () => {
    ...
    try {
      await client.createCluster.mutate({
        ...formData,
...
const CreateClusterWizard: React.FC<CreateClusterWizardProps> = ({ isOpen, onClose, client }) => {
  const getCloudProfilesPromises = client.getCloudProfiles.query()
