...
// OpenStack might return different network names than just "private"
...
export const serverSchema = z
  .object({
    ...
    // More flexible addresses schema
    ...
    image: z
      ...
      .or(z.string()) // Sometimes OpenStack just returns the image ID as a string
      .optional()
      .nullable(),
    ...
    // Fix 3: Accept non-hyphenated versions of these fields as well
