  ...
  describe("Confirmation", () => {
    test("calls mutateAsync for each selected container on confirm", async () => {
      ...
      await waitFor(() => {
        ...
        expect(mockMutateAsync).toHaveBeenCalledWith({ container: "beta", project_id: mockProjectId })
        expect(mockMutateAsync).toHaveBeenCalledWith({ container: "gamma", project_id: mockProjectId })
      })
    })
