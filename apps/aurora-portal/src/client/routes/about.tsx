  ...
  return (
    <div className="min-h-screen flex items-start justify-start bg-gray-100 px-6 mt-10">
      <div className="max-w-4xl w-full">
        <h1 className="text-5xl font-bold  mb-8">About Aurora Dashboard</h1>
        ...
        <h2 className="text-3xl font-semibold  mt-10 mb-4">Why Choose Aurora?</h2>
        <p className="text-lg leading-relaxed">
        ...
        <h2 className="text-3xl font-semibold  mt-10 mb-4">Get Involved</h2>
        <p className="text-lg  leading-relaxed">
        ...
        <p className="mt-6 text-lg ">Together, we can unlock the true potential of your cloud infrastructure.</p>
      </div>
    </div>
  )
}
